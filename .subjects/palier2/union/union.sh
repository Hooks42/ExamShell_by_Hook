path_executable=".subjects/palier2/union/argv_union"
path_exo=".subjects/palier2/union/union.c"
path_trace=".subjects/palier2/union/trace.txt"
...
path_correct=".subjects/palier2/union/Correct_union"
path_fichier="$HOME/Desktop/Exam/Rendu/union/union.c"
path_correct_trace=".subjects/palier2/union/trace_exo.txt"
path_forbidden=".subjects/palier2/union/forbidden.txt"
path_result_diff=".subjects/palier2/union/result_diff.txt"

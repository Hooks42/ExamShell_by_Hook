path_executable=".subjects/palier2/last_word/argv_last_word"
path_exo=".subjects/palier2/last_word/last_word.c"
path_trace=".subjects/palier2/last_word/trace.txt"
...
path_correct=".subjects/palier2/last_word/Correct_last_word"
path_fichier="$HOME/Desktop/Exam/Rendu/last_word/last_word.c"
path_correct_trace=".subjects/palier2/last_word/trace_exo.txt"
path_forbidden=".subjects/palier2/last_word/forbidden.txt"
path_result_diff=".subjects/palier2/last_word/result_diff.txt"

path_executable=".subjects/palier3/epur_str/argv_epur_str"
path_exo=".subjects/palier3/epur_str/epur_str.c"
path_trace=".subjects/palier3/epur_str/trace.txt"
...
path_correct=".subjects/palier3/epur_str/Correct_epur_str"
path_fichier="$HOME/Desktop/Exam/Rendu/epur_str/epur_str.c"
path_correct_trace=".subjects/palier3/epur_str/trace_exo.txt"
path_forbidden=".subjects/palier3/epur_str/forbidden.txt"
path_result_diff=".subjects/palier3/epur_str/result_diff.txt"

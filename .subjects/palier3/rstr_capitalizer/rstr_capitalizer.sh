path_executable=".subjects/palier3/rstr_capitalizer/argv_rstr_capitalizer"
path_exo=".subjects/palier3/rstr_capitalizer/rstr_capitalizer.c"
path_trace=".subjects/palier3/rstr_capitalizer/trace.txt"
...
path_correct=".subjects/palier3/rstr_capitalizer/Correct_rstr_capitalizer"
path_fichier="$HOME/Desktop/Exam/Rendu/rstr_capitalizer/rstr_capitalizer.c"
path_correct_trace=".subjects/palier3/rstr_capitalizer/trace_exo.txt"
path_forbidden=".subjects/palier3/rstr_capitalizer/forbidden.txt"
path_result_diff=".subjects/palier3/rstr_capitalizer/result_diff.txt"

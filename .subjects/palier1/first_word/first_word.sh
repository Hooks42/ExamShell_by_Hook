path_executable=".subjects/palier1/first_word/argv_first_word"
path_exo=".subjects/palier1/first_word/first_word.c"
path_trace=".subjects/palier1/first_word/trace.txt"
...
test1="FOR PONY"
test2="this        ...       is sparta, then again, maybe    not"
test3="   "
test4="a"
test5="  lorem,ipsum  "
...
path_correct=".subjects/palier1/first_word/Correct_first_word"
path_fichier="$HOME/Desktop/Exam/Rendu/first_word/first_word.c"
path_correct_trace=".subjects/palier1/first_word/trace_exo.txt"
path_forbidden=".subjects/palier1/first_word/forbidden.txt"
path_result_diff=".subjects/palier1/first_word/result_diff.txt"
